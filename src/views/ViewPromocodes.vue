<template>
  <div class="default-promocodes">
    <div class="default-promocodes__subtop-line subtop-line">
      <p class="subtop-line__text">
        Отправленные {{ activePromosNumber }}/{{ promosNumber }}
      </p>
      <ButtonCreate to="/promocodes/create" class="subtop-line__button-create">
        Создать промокод
      </ButtonCreate>
    </div>

    <div class="default-promocodes__empty" v-if="isEmpty">
      <img
    ...
    <TransitionGroup tag="div" name="list" v-else>
      <PromocodesPromocodeItem
          ...
          :key="j"
          :promocode="promocode"
          class="default-promocodes__promocode"
