<template>
	<section class="price-edit">
		...
		<div class="price-edit__item-block second-price-item">
			...
			<div class="price-edit__wrapper">
				<div class="second-price-item__input-container" v-if="price.price_divison === 1">
				...
				<input type="number" step="1" min="1" v-model="price.price_divison" v-if="price.price_divison !== 1"
					:class="{ _hidden: !price.second_price_visibility }" class="price-edit__input form__input" />
			...
			<div class="price-edit__buttons">
				...
				<Button class="price-edit__button" :color="price.price_divison !== 1 ? blueColor : ''"
		...
		<div class="price-edit__item-block text-item">
			...
			<div class="price-edit__wrapper">
				<textarea type="text" v-model="price.text_1" :class="{ _hidden: !price.text_1_visibility }"
					class="price-edit__input form__textarea span-1-4"></textarea>
			</div>
			<div class="price-edit__buttons">
				<Button class="price-edit__button" :color="!price.text_1_visibility ? blueColor : ''"
		...
		<div class="price-edit__item-block text-item">
			...
			<div class="price-edit__wrapper">
				<textarea type="text" v-model="price.text_2" :class="{ _hidden: !price.text_2_visibility }"
					class="price-edit__input form__textarea span-1-4"></textarea>
			</div>
			<div class="price-edit__buttons">
		...
		<ButtonColored class="price-edit__save" @click="updatePrice"></ButtonColored>
	</section>
</template>
